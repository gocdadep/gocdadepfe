      ...
      <main className="max-w-3xl mx-auto px-6 py-16 flex-1 w-full pt-24 space-y-8">
        <article className="prose max-w-none text-left space-y-6 text-slate-700">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-950">1. Dữ Liệu Chúng Tôi Thu Thập</h2>
            <p className="text-sm leading-relaxed">
              Khi bạn tương tác với <code className="text-emerald-750 bg-zinc-100 px-1 rounded">gocdadep.com</code>, hệ thống tự động ghi nhận các thông tin kỹ thuật tiêu chuẩn từ trình duyệt của bạn (Dữ liệu Log), bao gồm:
            </p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-950">2. Cách Thức Sử Dụng Dữ Liệu</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-950">4. Tích Hợp Dịch Vụ Từ Bên Thứ Ba (Quảng Cáo và Tiếp Thị Liên Kết)</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-950">5. Bảo Mật Thông Tin</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-950">6. Thay Đổi Chính Sách Bảo Mật</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-950">7. Liên Hệ Với Chúng Tôi</h2>
            <p className="text-sm leading-relaxed">
              Nếu bạn có bất kỳ câu hỏi hoặc đóng góp nào liên quan đến Chính sách bảo mật này, vui lòng liên hệ với Ban quản trị qua email <strong>contact@gocdadep.com</strong>.
            </p>
          </section>
        </article>
      </main>
